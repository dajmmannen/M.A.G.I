package {
	...
	public class gameEngine extends MovieClip {
		...
		public static var fireBallTimer = 2500;
		public static var rangedTimer:Timer = new Timer(fireBallTimer);
		var objIndex;
		var enemyIndex;
		var mAZ;
		var lastMove = 3;
			...
			function frameUpdater(e) {
				...
				if (space == true) {
					if(canMeleeAttack==true) {
						...
						//myTimer.stop()
						myTimer = new Timer (global.Global.swingTime)
						myTimer.start()
						if(lastMove==UP) {
						...
						if(collTest) {
							...
							trace(global.Global.damageMultiplier)
